...
# ---------------------------------------------------------------------------
# M4 catalogue / inventory errors
# ---------------------------------------------------------------------------


class ProductInactive(DukaPosError):
    """Raised when an inactive product is used in a sellable operation."""


class SupplierNotFound(DukaPosError):
